...
document.querySelectorAll('.view-book').forEach(button => {
    button.addEventListener('click', function() {
        ...
        document.getElementById('viewBookCopiesTotal').textContent = ejemplaresTotales;
        document.getElementById('viewBookCopiesAvailable').textContent = ejemplaresDisponibles;
    });
});
