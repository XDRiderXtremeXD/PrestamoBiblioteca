...
<body>
	...
	<main class="p-4 bg-body-tertiary">
		...
		<section class="card border">
			...
			<div class="card-body">
			<a href="LibroServlet?type=list">Mostrar Libros</a>
					...
					<table id="tablaLibros" class="table table-striped table-sm">
						...
						<tbody>
							...
							<tr>
								...
								<td><%=item.getEjemplaresTotales()%></td>
								...
								<td><a
									href="LibroServlet?type=view&id=<%=item.getIdLibro()%>" id=""><img
										src="img/ic_view.png" width="20" height="20" title="Info"></a>
									<a href="LibroServlet?type=info&id=<%=item.getIdLibro()%>"
									id=""><img src="img/ic_info.png" width="20" height="20"
										title="Info"></a> <a
									href="LibroServlet?type=delete&id=<%=item.getIdLibro()%>" id=""><img
										src="img/ic_delete.png" width="20" height="20"
										title="Eliminar"></a></td>
							</tr>
							<%
							}
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="post" id="addBookForm">
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="addBookAuthor" class="form-label">Autor</label> <select
									class="selectpicker form-control" id="addBookAuthor"
									data-live-search="true" title="Seleccione un autor" required>
							...
							<div class="col-md-6 mb-3">
								...
								<select class="selectpicker form-control" id="addBookPublisher"
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								<label for="addBookGenre" class="form-label">Género</label> <select
									class="selectpicker form-control" id="addBookGenre"
									data-live-search="true" title="Seleccione un género" required>
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="addBookCourse" class="form-label">Curso</label> <select
									class="selectpicker form-control" id="addBookCourse"
							...
							<div class="col-md-6 mb-3">
								<label for="addBookState" class="form-label">Estado</label> <select
									class="selectpicker form-control" id="addBookState"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="post" id="addBookForm">
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="editBookAuthor" class="form-label">Autor</label> <select
									class="selectpicker form-control" id="editBookAuthor"
									data-live-search="true" title="Seleccione un autor" required>
							...
							<div class="col-md-6 mb-3">
								...
								<select class="selectpicker form-control" id="editBookPublisher"
									data-live-search="true" name="Seleccione una editorial"
									required>
									<option value="1">Penguin Random House</option>
									<option value="2">Planeta</option>
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								<label for="editBookGenre" class="form-label">Género</label> <select
									class="selectpicker form-control" id="editBookGenre"
									data-live-search="true" name="Seleccione un género" required>
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="editBookCourse" class="form-label">Curso</label> <select
									class="selectpicker form-control" id="editBookCourse"
							...
							<div class="col-md-6 mb-3">
								<label for="editBookState" class="form-label">Estado</label> <select
									class="selectpicker form-control" id="editBookState"
