...
public class PrestamoDevolucionServlet extends HttpServlet {
    ...
    private void getPrestamoDevolucion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //  request.getRequestDispatcher("prestamoDevolucionView.jsp").forward(request, response);
    }

    // Método para listar todos los prestamos y devoluciones
    private void listPrestamosDevoluciones(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        PrestamoDevolucionModel model = new PrestamoDevolucionModel();
        List<PrestamoDevolucion> data = model.listPrestamo();  // Llamada al modelo para obtener la lista de prestamos/devoluciones
        ...
        List<Estudiante> estudiantes = model3.listEstudiante();  // Llamada al modelo para obtener la lista de prestamos/devoluciones
    ...
    private void createPrestamoDevolucion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void updatePrestamoDevolucion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int id = Integer.parseInt(request.getParameter("id"));
        String Libro = request.getParameter("idLibro");
        String Estudiante = request.getParameter("idEstudiante");
        String fechaPrestamo = request.getParameter("fechaPrestamo");
